...
export const topicIconMap = { // Maps topic names to Lucide icons for display
  ...
  Synonyms: Lightbulb,
  Antonyms: Trophy,
  'Error Spotting': BadgeCheck,
  'Fill in the Blanks': Activity,
  'Sentence Improvement': Sparkles,
  'Sentence Completion': Lightbulb,
  'Idioms and Phrases': Award,
  'One Word Substitution': BrainCircuit,
  'Phrasal Verbs': Activity,
  Comprehension: PieChart,
  'Cloze Test': Sparkles,
  'Active and Passive Voice': BadgeCheck,
  'Direct and Indirect Speech': Lightbulb,
  Tenses: TrendingUp,
  Articles: Percent,
  Prepositions: Target,
